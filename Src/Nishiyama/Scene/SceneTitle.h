...
//ｂｇｍパス
constexpr char TITLE_BGM_PATH[128] = "Data/Sound/SceneTitle/backbgm.mp3";
//SEパス
constexpr char TITLE_SE_PATH[128] = "Data/Sound/SceneTitle/決定ボタンを押す12.mp3";
constexpr char TITLE_START_BOTTAN_SE_PATH[128] = "Data/Sound/SceneTitle/決定ボタンを押す47.mp3";
